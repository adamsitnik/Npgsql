...
namespace Npgsql.Tests
{
    public abstract class TestBase
    {
        ...
        /// test database.
        /// </summary>
        const string DefaultConnectionString = "Server=localhost;Username=npgsql_tests;Password=npgsql_tests;Database=npgsql_tests;Timeout=0;Command Timeout=0;No Reset On Close=true;Server Compatibility Mode=NoTypeLoading";
