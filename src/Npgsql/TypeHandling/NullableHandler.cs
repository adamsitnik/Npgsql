...
namespace Npgsql.TypeHandling
{
    ...
    static class NullableHandler<T>
    {
        ...
        [DisallowNull] public static readonly ReadDelegate<T> Read;
        [DisallowNull] public static readonly ReadAsyncDelegate<T> ReadAsync;
        [DisallowNull] public static readonly ValidateAndGetLengthDelegate<T> ValidateAndGetLength;
        [DisallowNull] public static readonly WriteAsyncDelegate<T> WriteAsync;
